                ...
                <span class="relative z-0 inline-flex rounded-md">
                    ...
                    <?php if(!$paginator->onFirstPage()): ?>
                        <a href="<?php echo e($paginator->previousPageUrl()); ?>" rel="next"
                            ...
                            aria-label="<?php echo e(__('pagination.prev')); ?>">
                            ...
                            <?php $__currentLoopData = $element; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $page => $url): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <?php if($page == $paginator->currentPage()): ?>
                                    <span aria-current="page">
                                        <span
                                            class="h-10 w-10 bg-blue-800 hover:bg-blue-600 font-semibold text-white text-sm flex items-center justify-center"><?php echo e($page); ?></span>
                                    </span>
                                <?php else: ?>
...
<?php endif; ?>
<?php /**PATH D:\Coding Challege\blog-app\resources\views/vendor/pagination/tailwind.blade.php ENDPATH**/ ?>