...
} elseif ($_instance->childHasBeenRendered('dBGsQUK')) {
    $componentId = $_instance->getRenderedChildComponentId('dBGsQUK');
    $componentTag = $_instance->getRenderedChildComponentTagName('dBGsQUK');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('dBGsQUK');
} else {
    $response = \Livewire\Livewire::mount('notifications');
    $html = $response->html();
    $_instance->logRenderedChild('dBGsQUK', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
 <?php echo $__env->renderComponent(); ?>
...
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
<?php endif; ?>
<?php /**PATH D:\Coding Challege\blog-app\vendor\filament\filament\src\/../resources/views/components/layouts/card.blade.php ENDPATH**/ ?>