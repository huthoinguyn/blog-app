...
} elseif ($_instance->childHasBeenRendered('PrrVcCj')) {
    $componentId = $_instance->getRenderedChildComponentId('PrrVcCj');
    $componentTag = $_instance->getRenderedChildComponentTagName('PrrVcCj');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('PrrVcCj');
} else {
    $response = \Livewire\Livewire::mount('filament.core.global-search');
    $html = $response->html();
    $_instance->logRenderedChild('PrrVcCj', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
} elseif ($_instance->childHasBeenRendered('H6mZkHQ')) {
    $componentId = $_instance->getRenderedChildComponentId('H6mZkHQ');
    $componentTag = $_instance->getRenderedChildComponentTagName('H6mZkHQ');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('H6mZkHQ');
} else {
    $response = \Livewire\Livewire::mount('filament.core.notifications');
    $html = $response->html();
    $_instance->logRenderedChild('H6mZkHQ', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php /**PATH D:\Coding Challege\blog-app\vendor\filament\filament\src\/../resources/views/components/topbar.blade.php ENDPATH**/ ?>