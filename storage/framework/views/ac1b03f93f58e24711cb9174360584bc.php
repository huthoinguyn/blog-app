...
<?php endif; ?>
    ...
    <span id="<?php echo e($this->id); ?>.table.selection.indicator.record-count.<?php echo e($allRecordsCount); ?>" x-show="<?php echo e($allRecordsCount); ?> !== selectedRecords.length">
        <button x-on:click="selectAllRecords" class="text-sm font-medium text-primary-600">
            <?php echo e(trans_choice('tables::table.selection_indicator.buttons.select_all.label', $allRecordsCount)); ?>.
        </button>
    </span>
...
<?php /**PATH D:\Coding Challege\blog-app\vendor\filament\tables\src\/../resources/views/components/selection-indicator.blade.php ENDPATH**/ ?>